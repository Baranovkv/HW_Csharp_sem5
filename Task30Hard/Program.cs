...
{
    int temp = new Random().Next(-100,101); // переменная для значения каждого нового элемента массива
    fillArray[0] = new Random().Next(-100,101); // первый элемент сразу задаем случайно
